...
public class Client extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        root.setBackground(new Background(new BackgroundFill(Color.LIGHTPINK, null, null))); // задаётся цвет фона
        Scene scene = new Scene(root,8000,500);
        ...
        buttonGetHelp.setOnAction(e -> {
            ...
            flowPane.setBackground(new Background(new BackgroundFill(Color.LIGHTPINK, null, null)));
            Scene secondScene = new Scene(flowPane, 565, 400);
        ...
        buttonSendId.setOnAction(ep -> {
            if (string == "filter_greater_than_height") {
                ...
                if ((toRemove.getText() == "") || (toRemove.getText().trim().length() == 0)) {
                    ...
                    Scene secondScene = new Scene(scrollPane, 765, 450);
                    Stage newWindow = new Stage();
                ...
                if ((toAdd.getText() == "")|| (toAdd.getText().trim().length() == 0) || (!toAdd.getText().matches("[\\d]+"))) {
                    ...
                    text6.setText("Рост не может быть отрицательнымА");
                } else {
                    if (s == "add") {
                        flat.setArea((double) Long.parseLong(toAdd.getText()));
                        fl.setArea((double) Long.parseLong(toAdd.getText()));
                        string = "add_ageOfPerson";
                        adder.setSpacing(40);
                        text6.setText("Введите возраст:");
                        buttonSendId.setText("Подтвердить");
                        intorg.dublicatedPart();
                    } else if (s == "update_id"){
                        fl.setArea((double) Long.parseLong(toAdd.getText()));
            ...
            } else if (string == "add_ageOfPerson") {
                if ((toAdd.getText() == "") || (toAdd.getText().trim().length() == 0) || (!toAdd.getText().matches("[\\d]+"))) {
                    text6.setText("Возраст не может быть пустым\n" +
                            " и не может содержать букв");
                } else if (Long.parseLong(toAdd.getText()) <= 0) {
                    text6.setText("Возраст не может\n" +
                            " быть отрицательным");
                } else {
                    if (s == "add") {
                        ...
                        string = "add_color1";
                        adder.setSpacing(20);
                        text6.setText("Выберите цвет глаз:");
                        buttonSendId.setText("Подтвердить");
                        toAdd.clear();
                ...
                if ((strin == null)|| (strin == "") || (strin.trim().length() == 0)){
                    ...
                    if (s == "add") {
                        ...
                        adder.getChildren().remove(buttonSendId);
                        vBox.getChildren().remove(adder);
                        text6.setText("Выберите транспортное средство:");
                        adder.getChildren().add(text6);
                        buttonSendId.setText("Подтвердить");
               ...
               String str = transportBox.getSelectionModel().getSelectedItem();
                ...
                if (!toAdd.getText().matches("[\\d]+")) {
                    ...
                    text6.setText("Введите место работы");
                    string = "add_job";
                    buttonSendId.setText("Подтвердить");
            ...
            } else if (string == "add_job") {
                if ((toAdd.getText() == "") || (toAdd.getText().trim().length() == 0)) {
                    text6.setText("Поле job\n" +
                            " не может быть пустым");
                } else {
                    house = toAdd.getText();
                    string = "add_workExperience";
                    if (s == "add"){
                        adder.setSpacing(20);
                        text6.setText("Введите стаж работы");
                        buttonSendId.setText("Подтвердить");
                        intorg.dublicatedPart();
                    } else if (s == "update_id"){
                        adder1.setSpacing(20);
            ...
            } else if (string == "add_workExperience") {
                if ((toAdd.getText() == "") || (toAdd.getText().trim().length() == 0)) {
                    text6.setText("Поле workExperience\n" +
                            " не может быть пустым ");
                } else {
                    ...
                    if (s == "add"){
                        adder.setSpacing(20);
                        text6.setText("Введите зарплату");
                        buttonSendId.setText("Подтвердить");
                        intorg.dublicatedPart();
                    } else if (s == "update_id"){
                        adder1.setSpacing(20);
            ...
            else if (string == "add_salary"){
                if ((!toAdd.getText().matches("[\\d]+"))) {
                    text6.setText("Поле salary\n" +
                            " не может содержать букв");
                } else if ((Long.parseLong(toAdd.getText()) <= 0) || (Long.parseLong(toAdd.getText()) > 1000000)) {
                    text6.setText("зарплата\n" +
                            " должжна быть больше 0,\n" +
                            " Максимальная зарплата: 1000000");
                } else {
        ...
        buttonGetInfo.setOnAction(e -> {
            ...
            if (CommandReader.s != null) {
                if (s == "remove_by_id"){
                    ...
                    text6.setText("Введите id граничного элемента.");
                    intorg.dublicatedPart2();
                } else if (s == "remove_by_workExperience") {
                    string = "remove_by_workExperience";
                    text6.setText("Введите стаж работы человека для удаления из коллекции");
                    intorg.dublicatedPart2();
                }
                else if (s == "update_id") {
                    textInfo.setText(null);
                    string = "add_name";
                    adder.setSpacing(20);
                    text6.setText("Введите имя нового персонажа");
                    adder1.getChildren().remove(text6);
                    adder1.getChildren().add(text6);
                    buttonSendId.setText("Подтвердить");
        ...
        buttonShow.setOnAction(e -> {
            ...
            if (flag == "finish") {
                ...
                TableColumn<Flat, Number> column3 = new TableColumn<>("height");
                TableColumn<Flat, Number> column4 = new TableColumn<>("ageOfPerson");
                TableColumn<Flat, Furnish> column5 = new TableColumn<>("color1");
                TableColumn<Flat, Transport> column6 = new TableColumn<>("transport");
                TableColumn<Flat, View> column7 = new TableColumn<>("view");
                TableColumn<Flat, String> housename = new TableColumn<>("job");
                TableColumn<Flat, Integer> age = new TableColumn<>("workExperience");
                TableColumn<Flat, Integer>  lifts= new TableColumn<>("salary");
                ...
                column4.setCellValueFactory(new PropertyValueFactory<>("ageOfPerson"));
                ...
                housename.setCellValueFactory(new PropertyValueFactory<>("job"));
                lifts.setCellValueFactory(new PropertyValueFactory<>("workExperience"));
                age.setCellValueFactory(new PropertyValueFactory<>("salary"));
                ...
                tableView.setMinSize(700, 350);
                tableView.setMaxSize(700, 350);
                ...
                housename.setOnEditCommit((TableColumn.CellEditEvent<Flat, String> event) -> {
                    ...
                    String newName = event.getNewValue();
                    if ((newName == "")||(newName.trim().length() == 0)){
                        textInfo.setText("Поле job не может быть пустым");
                    } else {
                        int row = pos.getRow();
                        fl = event.getTableView().getItems().get(row);
        ...
        buttonVisual.setOnAction(act ->{
            if (userFlag != "finish") {
                s = "users";
                new CommandReader();
                textInfo.setText("Для появления персонажей нажмите трижды на кнопку 'персонажи'");
            }
            if (userFlag == "finish") {
                s = "show";
                new CommandReader();
                textInfo.setText("Для появления персонажей нажмите ещё раз на кнопку 'персонажи'");
                if (flag == "finish") {
