...
public class Localize {
    ...
    public static Text text5 = new Text("Регистрация");
    ...
    public static Button buttonVisual = new Button("персонажи");
    public Localize(){}
    ...
    public void setRussian(){
        ...
        buttonVisual.setText("персонажи");
