        ...
        try {
           switch (s){
               ...
               case "users":
                   ...
                   break;
                                                ...
                                                case "countByAge":
                                                    ...
                                                    history.add(s);
                                                    long ii = 2;
                                                    ComplicatedObject heightSum = new ComplicatedObject("countByAge", ii);
               ...
               case "remove_by_workExperience":
                            ...
                            ComplicatedObject removeByHouseAge = new ComplicatedObject("remove_by_workExperience", removeId, getLogin );
